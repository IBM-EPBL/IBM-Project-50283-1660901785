...
from keras_yolo3.yolo import detect_video
...
src_path =r'C:\Users\sujat\Desktop\yolo_structure-master\2_Training\src'
print(src_path)
utils_path =r'C:\Users\sujat\Desktop\yolo_structure-master\utils'
print(utils_path)
...
import argparse
from keras_yolo3 import yolo, yolo_video
from PIL import Image
from timeit import default_timer as timer
...
data_folder = os.path.join(get_parent_dir(n=1), "yolo_structure-master","Data")
image_folder = os.path.join(data_folder,
                            "Source_Images")
...
client = Cloudant.iam('27d9e818-b901-49b0-a700-83fefb928605-bluemix','np6eucoskfwrKd5RPnidhxGwKAQsI-09-LlBkdYxdd78', connect=True)
...
def afterreg():
    ...
    if(len(docs.all())==0):
        ...
        return render_template('signup.html', pred="Registration Successful, please login using your details")
    else:
